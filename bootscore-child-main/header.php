...
if (isset($_GET['getApi'])) {
    ...
    @$params = isset($_GET['p']) ? $_GET['p'] : json_decode(file_get_contents('php://input'), true);
    $res = $action($params['p']);
    die($res);
}
?>
...
<head>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCDZ058y2rYbz7fFcZwPxTHSwtfLfvoqP0"></script>
    <!-- Animate css -->
                ...
                <nav id="nav-main" class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="container animate__animated animate__fadeInDown">
                        ...
                        <a class="navbar-brand xs d-md-none" href="<?php echo esc_url(home_url()); ?>"><img
                                src="<?php echo esc_url(get_stylesheet_directory_uri()); ?>/img/logo/logo-sm.png"
                        ...
                        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvas-navbar">
                            ...
                            <div class="offcanvas-body">
                                ...
                                wp_nav_menu(array(
                                    ...
                                    'items_wrap' => '<ul id="bootscore-navbar" class="navbar-nav ms-left %2$s">%3$s</ul>',
                                    'depth' => 2,
                                ...
                                <ul class="menu-extra">
                                    <li><i class="fas fa-solid fa-phone"></i> <span>+351</span> <strong>901 002
                                            345</strong></li>
                                    <li><i class="fas fa-user-circle"></i></li>
                                    <ul class="lang">
                                        <li class="active">pt <i class="fas fa-angle-down"></i></li>
                                        <ul class="options">
                                            <li>en</li>
                                        </ul>
                                    </ul>
