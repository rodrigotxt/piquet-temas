...
if (!function_exists('the_breadcrumb')) :
  function the_breadcrumb() {
    if (!is_home()) {
      echo '<nav class="breadcrumb mb-4 mt-2 py-2 small rounded">';
      echo '<a href="' . home_url('/') . '">' . ('Home') . '</a><span class="divider">&nbsp;<i class="fas fa-chevron-right"></i>&nbsp;</span>';
      if (is_category() || is_single()) {
        the_category(' <span class="divider">&nbsp;<i class="fas fa-chevron-right"></i>&nbsp;</span> ');
        if (is_single()) {
          echo ' <span class="divider">&nbsp;<i class="fas fa-chevron-right"></i>&nbsp;</span> ';
          the_title();
        }
      } elseif (is_page()) {
        echo the_title();
